...
export const menuItems: MenuItem[] = [
  {
    ...
    subMenu: [
      ...
      { id: 'struktur-organisasi', label: 'Struktur Organisasi', href: '/profil/struktur-organisasi' },
  ...
  },
{
    ...
    subMenu: [
      ...
      { id: 'pedoman-tugas-akhir', label: 'Pedoman Tugas Akhir', href: '/akademik/pedoman-tugas-akhir' },
      { id: 'pedoman-kkp', label: 'Pedoman Kuliah Kerja Praktek', href: '/akademik/pedoman-kuliah-kerja-praktek' },
      { id: 'ketentuan-komprehensif', label: 'Ketentuan Komprehensif', href: '/akademik/ketentuan-komprehensif' },
  ...
  },
{
    ...
    badge: null,
    subMenu: [
      { id: 'prestasi-akademik', label: 'Prestasi Akademik', href: '/kemahasiswaan/prestasi-akademik' },
      { id: 'prestasi-non-akademik', label: 'Prestasi Non-Akademik', href: '/kemahasiswaan/prestasi-non-akademik' },
      { id: 'mahasiswa-ipk-tertinggi', label: 'Mahasiswa IPK Tertinggi', href: '/kemahasiswaan/mahasiswa-ipk-tertinggi' },
  ...
  },
  {
    ...
    label: 'Berita',
    icon: Newspaper,
    bgClass: 'bg-scitech-navy-glare text-scitech-mint hover:bg-scitech-mint hover:text-scitech-navy',
    badge: 2,
    subMenu: []
  }
];
