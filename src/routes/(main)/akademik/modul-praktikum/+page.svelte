<script lang="ts">
	...
	// State Modal Preview Gambar Modul
...
<div class="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
	...
	<div class="mb-10 border-b border-border-color/40 pb-6 text-center sm:text-left">
		...
		<p class="mt-2 text-sm text-text-muted">
			Kumpulan panduan, materi, dan instruksi kerja praktikum untuk kegiatan laboratorium mahasiswa.
		</p>
	</div>
	...
	{#if data.modules && data.modules.length > 0}
		<div class="space-y-12">
			{#each data.modules as item, index (item.id)}
...
<style>
	/* Styling kustom untuk merender tabel dan elemen HTML di {@html} */
	:global(.prose h1),
	:global(.prose h2),
	:global(.prose h3) {
		color: #ffffff;
