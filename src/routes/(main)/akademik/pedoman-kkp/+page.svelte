...
<div class={`${classTopSpace} mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8`}>
	<div class="mb-10 border-b border-border-color/40 pb-6 text-center sm:text-left">
		...
		<p class="mt-2 text-sm text-text-muted">
			Petunjuk pelaksanaan, syarat administrasi, dan alur pelaporan Kuliah Kerja Praktek / Kerja
			Lapangan.
		</p>
	</div>
	...
	{:else}
		<!-- EMPTY STATE -->
		<EmptyData
			title="Pedoman KKP Belum Tersedia"
			description="Belum ada informasi atau dokumen pedoman KKP yang diterbitkan. Silakan hubungi koordinator KKP."
		/>
	{/if}
</div>
