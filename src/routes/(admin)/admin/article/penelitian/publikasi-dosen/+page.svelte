	...
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
		...
		>
			...
			>
				...
				<!-- Nama Dosen -->
				<div>
					<label for="lecturer_name" class="text-text-muted mb-1 block text-xs font-medium">
				...
				<!-- Link SINTA -->
				<div>
					<label for="sinta_link" class="text-text-muted mb-1 block text-xs font-medium">
						Link Profil SINTA
					</label>
					<input
						id="sinta_link"
				...
				<!-- Link Google Scholar -->
				<div>
					<label for="scholar_link" class="text-text-muted mb-1 block text-xs font-medium">
