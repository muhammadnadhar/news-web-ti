...
<div class="container">
	<!-- <header class="header"> -->
	<!-- 	<a href="/admin/kemahasiswaan/beasiswa" class="btn-back">← Kembali ke Daftar Beasiswa</a> -->
		...
		<form method="POST" use:enhance class="form">
			...
			<div class="form-group">
				<label for="scholarship_name"
					>Nama Beasiswa / Kategori <span class="required">*</span></label
				>
				<input
					type="text"
					id="scholarship_name"
					name="scholarship_name"
					value={form?.values?.scholarshipName || ''}
					placeholder="Contoh: Beasiswa KIP Kuliah 2026 / Beasiswa Prestasi"
					required
				/>
			</div>

			<!-- Field: Upload Foto Penerima Beasiswa dengan Cloudinary -->
			<div class="form-group">
				<label for="image_upload">Foto Mahasiswa Penerima Beasiswa</label>
				<input type="hidden" name="image_url" value={imageUrl} />

				{#if imageUrl}
					<div class="image-preview">
						<img src={imageUrl} alt="Foto Penerima Beasiswa" />
